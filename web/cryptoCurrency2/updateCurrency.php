...
for($i = 0; $i < count($currency_names); $i++){
	...
	print("looking " . number_format($price, 2) . number_format(($volume/1000000),1) . $currency_names[$i] . $_SESSION['userID'] . "<br>");
	...
	$stmt->bindValue(':volumes', number_format(($volume/1000000),1));
