...
for($i = 0; $i < count($currency_names); $i++){
	...
	$price = $values["data"][$currency_names[$i]]["quote"]["USD"]["price"];
	$volume = $values["data"][$currency_names[$i]]["quote"]["USD"]["volume_24h"];
	print("looking " .$currency_names[$i] . $price . $volume . "<br>");
